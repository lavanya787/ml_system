...
class ModelHandler:
    ...
    def train_education_models(self, processed_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        df = processed_data.get('processed_features')
        target_col = processed_data.get('target_variable')
    ...
    def _is_classification_task(self, y: pd.Series) -> bool:
        ...
        # If target is categorical or few unique numeric values -> classification
