...
# Enhanced test function with professional formatting
def test_enhanced_query_handler():
    """Comprehensive test of the enhanced QueryHandler."""
    print("🧪 Testing Enhanced QueryHandler")
    print("=" * 60)
    ...
    sample_data = pd.DataFrame({
        'student_id': ['STU0001', 'STU0002', 'STU0003', 'STU0004', 'STU0005'],
        'name': ['Alice Johnson', 'Bob Smith', 'Charlie Brown', 'Diana Prince', 'Eve Wilson'],
        'mathematics': [85, 92, 78, 88, 95],
        'physics': [88, 85, 82, 90, 87],
        'chemistry': [90, 88, 85, 92, 89],
        'computer_science': [95, 90, 88, 85, 92],
        'total_marks': [358, 355, 333, 355, 363]
    })
    ...
    test_queries = [
        ...
        "What are the mathematics marks of STU0004?",
        "Display top 3 students by total marks",
        "Calculate average physics scores",
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        # Validate query
        validation = handler.validate_query_format(query)
        ...
        # Show suggestions
        suggestions = handler.generate_dynamic_suggestions(query, sample_data)
        if suggestions:
            print(f"\n💡 Smart Suggestions:")
            for suggestion in suggestions:
                print(f"   {suggestion}")
    ...
    print(handler.get_interactive_help())
