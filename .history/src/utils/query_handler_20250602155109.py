...
if __name__ == "__main__":
    ...
    test_query = "What is the prediction for next month?"
    result = query_handler.handle_query(
        query=test_query,
        user_id="test_user"
    )
    
    print("\n=== Prediction Query Test ===")
    print(json.dumps(result, indent=2, default=str))
    
    # Test performance query
    performance_query = "Show me the model performance metrics"
    performance_result = query_handler.handle_query(
        query=performance_query,
        user_id="test_user"
    )
    
    print("\n=== Performance Query Test ===")
    print(json.dumps(performance_result, indent=2, default=str))
    
    # Test general query
    general_query = "Tell me about the data"
    general_result = query_handler.handle_query(
        query=general_query,
        user_id="test_user"
    )
    
    print("\n=== General Query Test ===")
    print(json.dumps(general_result, indent=2, default=str))
    
    # Test history query
    history_query = "Show my query history"
    history_result = query_handler.handle_query(
        query=history_query,
        user_id="test_user"
    )
    ...
    print("\n=== Testing Complete ===")
    print("All queries should now generate proper responses!")