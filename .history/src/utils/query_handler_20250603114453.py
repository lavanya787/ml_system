...
from utils.model_handler import ModelHandler  # Assuming this is defined elsewhere
...
class QueryHandler:
    ...
    def handle_query(self, query: str, user_id: str, domain_config: Any = None, 
        ...
        try:
            ...
            # Try model-specific Q&A first (if available and not history query)
            if model_handler and intent != 'history':
                try:
            ...
            if intent != 'history':  # Don't save history queries to history
