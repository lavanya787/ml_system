...
class QueryHandler:    
    ...
    """
    Generate a textual summary of the dataset based on statistical properties and optional natural language query.

    Args:
        df (pd.DataFrame): The DataFrame to summarize.
        query (str): Optional user query for tailored summarization.
