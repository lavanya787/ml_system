...
class EnhancedDomainConfig:
    """Enhanced domain configuration that can search through data effectively."""
    
    def __init__(self):
        self.name = "Data Search Domain Config"
...
def test_enhanced_query_handler():
    ...
    domain_config = EnhancedDomainConfig()
...
def integrate_with_query_handler():
    ...
    enhanced_domain_config = EnhancedDomainConfig()
    
    # Your data (replace with your actual data loading)
    # your_data = pd.read_csv('your_student_data.csv')
    
    # Example with sample data
    your_data = pd.DataFrame({
        'Name': ['Sai Munshi', 'John Doe', 'Jane Smith'],
        'Chemistry_Mark': [85, 92, 78],
        'Physics_Mark': [90, 87, 82],
        'Math_Mark': [88, 95, 85]
    })
    
    # Query your data
    result = query_handler.handle_query(
        query="what is the chemistry mark of sai munshi",
        domain_config=enhanced_domain_config,
        raw_data=your_data,
        processed_data={},
        models={},
        user_id="student_query_user"
    )
...
if __name__ == "__main__":
    print("Testing Enhanced Query Handler for Student Data\n")
    test_enhanced_query_handler()
    
    print("\n" + "="*60 + "\n")
    print("Integration Example:")
    integrate_with_query_handler()