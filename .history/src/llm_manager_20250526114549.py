...
class LLMManager:
    def __init__(self, distilbert_model: str = "distilbert-base-uncased", 
                 t5_model: str = "models/fine_tuned_t5", num_labels: int = 26, cache_size: int = 1000):
        # ... rest of the initialization remains the same        """Initialize LLM for domain classification, query processing, and response generation"""
