...
def upload_and_detect_page(self, selected_domain):
        ...
        uploaded_file = st.file_uploader("Upload your dataset (CSV format only)", type=["csv", "xls", "xlsx", "txt", "json", "pdf", "docx", "doc"]) 
        ...
        if uploaded_file is not None:
            try:
                ...
                if selected_domain == "Auto-Detect" or not selected_domain:
                    try:
                         ...
                         st.error(f"Domain detection error: {e}")
                ...
                st.warnng("No domain detected or selected. Processing skipped.")
