...
class MultiDomainMLSystem:
    ...
    def upload_and_detect_page(self):
        ...
        if uploaded_files:
            ...
            # Save last uploaded dataset to main session vars for simplicity
        ...
        st.session_state['dataset_uploaded'] = True  # Important: mark dataset uploaded!
        # Show preview of last uploaded dataset
