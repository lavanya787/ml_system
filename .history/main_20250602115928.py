...
class MultiDomainMLSystem:
    ...
    def upload_and_detect_page(self):
        ...
        if uploaded_files:
            ...
            for uploaded_file in uploaded_files:
                ...
                detected_domain = detected.get('domain', 'unknown')
    ...
    def intelligent_query_page(self):
        ...
        if question:
            ...
            # Rulelif any(k in question_lower for k in ["null", "missing"]):
        ...
        # === Fallback to LLM/QueryHandler for advanced queries ===
        else:
...
✅ Added better handling for numerical extraction using regex (top N rows).

✅ Enhanced support for multiple numeric column matches (mean, max, min).

✅ Added fallback info messages if a column name is not matched.

✅ Expanded keyword recognition (summary, info, features, etc.).

✅ Added logging for queries.

Would you also like to add visualizations (e.g., plots for “distribution of salary”)? I can help integrate that too.
